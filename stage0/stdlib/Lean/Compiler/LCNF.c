...
lean_object* runtime_initialize_Lean_Compiler_LCNF_EmitZig_InlineHelpers(uint8_t builtin);
lean_object* runtime_initialize_Lean_Compiler_LCNF_EmitZig_RuntimeExterns(uint8_t builtin);
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = runtime_initialize_Lean_Compiler_LCNF_EmitZig_InlineHelpers(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = runtime_initialize_Lean_Compiler_LCNF_EmitZig_RuntimeExterns(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
...
lean_object* initialize_Lean_Compiler_LCNF_EmitZig_InlineHelpers(uint8_t builtin);
lean_object* initialize_Lean_Compiler_LCNF_EmitZig_RuntimeExterns(uint8_t builtin);
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Lean_Compiler_LCNF_EmitZig_InlineHelpers(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Lean_Compiler_LCNF_EmitZig_RuntimeExterns(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
