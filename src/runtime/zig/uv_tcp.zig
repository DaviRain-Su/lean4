...
pub export fn lean_uv_tcp_send(socket: *anyopaque, data_array: *anyopaque) callconv(.c) *anyopaque {
...
pub export fn lean_uv_tcp_listen(socket: *anyopaque, backlog: i32) callconv(.c) *anyopaque {
...
pub export fn lean_uv_tcp_keepalive(socket: *anyopaque, enable: i32, delay: u32) callconv(.c) *anyopaque {
