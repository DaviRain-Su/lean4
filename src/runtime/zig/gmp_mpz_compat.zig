...
comptime {
    @export(&gmpzInit, .{ .name = "__gmpz_init", .linkage = .weak });
    @export(&gmpzClear, .{ .name = "__gmpz_clear", .linkage = .weak });
    @export(&gmpzSet, .{ .name = "__gmpz_set", .linkage = .weak });
    @export(&gmpzSetSi, .{ .name = "__gmpz_set_si", .linkage = .weak });
    @export(&gmpzSetUi, .{ .name = "__gmpz_set_ui", .linkage = .weak });
    @export(&gmpzSetStr, .{ .name = "__gmpz_set_str", .linkage = .weak });
    @export(&gmpzInitSet, .{ .name = "__gmpz_init_set", .linkage = .weak });
    @export(&gmpzInitSetSi, .{ .name = "__gmpz_init_set_si", .linkage = .weak });
    @export(&gmpzInitSetUi, .{ .name = "__gmpz_init_set_ui", .linkage = .weak });
    @export(&gmpzInitSetStr, .{ .name = "__gmpz_init_set_str", .linkage = .weak });
    @export(&gmpzSwap, .{ .name = "__gmpz_swap", .linkage = .weak });

    @export(&gmpzAdd, .{ .name = "__gmpz_add", .linkage = .weak });
    @export(&gmpzAddUi, .{ .name = "__gmpz_add_ui", .linkage = .weak });
    @export(&gmpzSub, .{ .name = "__gmpz_sub", .linkage = .weak });
    @export(&gmpzSubUi, .{ .name = "__gmpz_sub_ui", .linkage = .weak });
    @export(&gmpzMul, .{ .name = "__gmpz_mul", .linkage = .weak });
    @export(&gmpzMulSi, .{ .name = "__gmpz_mul_si", .linkage = .weak });
    @export(&gmpzMulUi, .{ .name = "__gmpz_mul_ui", .linkage = .weak });
    @export(&gmpzMul2exp, .{ .name = "__gmpz_mul_2exp", .linkage = .weak });
    @export(&gmpzPowUi, .{ .name = "__gmpz_pow_ui", .linkage = .weak });
    @export(&gmpzUiPowUi, .{ .name = "__gmpz_ui_pow_ui", .linkage = .weak });
    @export(&gmpzDivexact, .{ .name = "__gmpz_divexact", .linkage = .weak });
    @export(&gmpzTdivQ, .{ .name = "__gmpz_tdiv_q", .linkage = .weak });
    @export(&gmpzTdivQui, .{ .name = "__gmpz_tdiv_q_ui", .linkage = .weak });
    @export(&gmpzTdivQr, .{ .name = "__gmpz_tdiv_qr", .linkage = .weak });
    @export(&gmpzTdivR, .{ .name = "__gmpz_tdiv_r", .linkage = .weak });
    @export(&gmpzTdivQ2exp, .{ .name = "__gmpz_tdiv_q_2exp", .linkage = .weak });
    @export(&gmpzFdivQ2exp, .{ .name = "__gmpz_fdiv_q_2exp", .linkage = .weak });
    @export(&gmpzFdivR2exp, .{ .name = "__gmpz_fdiv_r_2exp", .linkage = .weak });
    @export(&gmpzFdivQr, .{ .name = "__gmpz_fdiv_qr", .linkage = .weak });
    @export(&gmpzFdivQ, .{ .name = "__gmpz_fdiv_q", .linkage = .weak });
    @export(&gmpzFdivR, .{ .name = "__gmpz_fdiv_r", .linkage = .weak });

    @export(&gmpzAnd, .{ .name = "__gmpz_and", .linkage = .weak });
    @export(&gmpzIor, .{ .name = "__gmpz_ior", .linkage = .weak });
    @export(&gmpzXor, .{ .name = "__gmpz_xor", .linkage = .weak });

    @export(&gmpzCmp, .{ .name = "__gmpz_cmp", .linkage = .weak });
    @export(&gmpzCmpSi, .{ .name = "__gmpz_cmp_si", .linkage = .weak });
    @export(&gmpzCmpUi, .{ .name = "__gmpz_cmp_ui", .linkage = .weak });
    @export(&gmpzFitsSintP, .{ .name = "__gmpz_fits_sint_p", .linkage = .weak });
    @export(&gmpzFitsUintP, .{ .name = "__gmpz_fits_uint_p", .linkage = .weak });
    @export(&gmpzFitsSlongP, .{ .name = "__gmpz_fits_slong_p", .linkage = .weak });
    @export(&gmpzFitsUlongP, .{ .name = "__gmpz_fits_ulong_p", .linkage = .weak });
    @export(&gmpzGetSi, .{ .name = "__gmpz_get_si", .linkage = .weak });
    @export(&gmpzGetUi, .{ .name = "__gmpz_get_ui", .linkage = .weak });
    @export(&gmpzGetD, .{ .name = "__gmpz_get_d", .linkage = .weak });
    @export(&gmpzGetlimbn, .{ .name = "__gmpz_getlimbn", .linkage = .weak });
    @export(&gmpzSize, .{ .name = "__gmpz_size", .linkage = .weak });
    @export(&gmpzSizeinbase, .{ .name = "__gmpz_sizeinbase", .linkage = .weak });
    @export(&gmpzGetStr, .{ .name = "__gmpz_get_str", .linkage = .weak });

    @export(&gmpzNeg, .{ .name = "__gmpz_neg", .linkage = .weak });
    @export(&gmpzAbs, .{ .name = "__gmpz_abs", .linkage = .weak });
    @export(&gmpzGcd, .{ .name = "__gmpz_gcd", .linkage = .weak });
}
