...
comptime {
    ...
    @export(&nopVoid, .{ .name = "_ZN4lean25initialize_kernel_moduleEv", .linkage = .strong });
    @export(&nopVoid, .{ .name = "_ZN4lean23finalize_kernel_moduleEv", .linkage = .strong });
    ...
    @export(&nopVoid, .{ .name = "_ZN4lean23initialize_util_moduleEv", .linkage = .strong });
    @export(&nopVoid, .{ .name = "_ZN4lean21finalize_util_moduleEv", .linkage = .strong });
