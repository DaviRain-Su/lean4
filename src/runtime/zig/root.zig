...
pub const io_errno = if (is_wasm) @import("io_errno_wasm.zig") else @import("io_errno.zig");
...
pub const net_addr = if (is_wasm) @import("net_addr_wasm.zig") else @import("net_addr.zig");
