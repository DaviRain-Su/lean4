...
pub export fn lean_uv_dns_get_info(host: *anyopaque, service: *anyopaque, family: u8) callconv(.c) *anyopaque {
    _ = host;
    _ = service;
    _ = family;
    noLibuv();
...
pub export fn lean_uv_dns_get_name(addr: *anyopaque) callconv(.c) *anyopaque {
    _ = addr;
    noLibuv();
}
...
pub export fn lean_uv_os_setpriority(pid: u64, priority: u64) callconv(.c) *anyopaque {
    _ = pid;
    _ = priority;
    noLibuv();
}
...
pub export fn lean_uv_random(size: u64) callconv(.c) *anyopaque {
    _ = size;
    noLibuv();
}
...
pub export fn lean_uv_tcp_new() callconv(.c) *anyopaque {
    noLibuv();
}

pub export fn lean_uv_tcp_connect(socket: *anyopaque, addr: *anyopaque) callconv(.c) *anyopaque {
    _ = socket;
    _ = addr;
    noLibuv();
}

pub export fn lean_uv_tcp_send(socket: *anyopaque, data: *anyopaque) callconv(.c) *anyopaque {
    _ = socket;
    _ = data;
    noLibuv();
}

pub export fn lean_uv_tcp_recv(socket: *anyopaque, buffer_size: u64) callconv(.c) *anyopaque {
    _ = socket;
    _ = buffer_size;
    noLibuv();
}

pub export fn lean_uv_tcp_wait_readable(socket: *anyopaque) callconv(.c) *anyopaque {
    _ = socket;
    noLibuv();
}

pub export fn lean_uv_tcp_cancel_recv(socket: *anyopaque) callconv(.c) *anyopaque {
    _ = socket;
    noLibuv();
}

pub export fn lean_uv_tcp_bind(socket: *anyopaque, addr: *anyopaque) callconv(.c) *anyopaque {
    _ = socket;
    _ = addr;
    noLibuv();
}

pub export fn lean_uv_tcp_listen(socket: *anyopaque, backlog: u32) callconv(.c) *anyopaque {
    _ = socket;
    _ = backlog;
    noLibuv();
}

pub export fn lean_uv_tcp_accept(socket: *anyopaque) callconv(.c) *anyopaque {
    _ = socket;
    noLibuv();
}

pub export fn lean_uv_tcp_try_accept(socket: *anyopaque) callconv(.c) *anyopaque {
    _ = socket;
    noLibuv();
}

pub export fn lean_uv_tcp_cancel_accept(socket: *anyopaque) callconv(.c) *anyopaque {
    _ = socket;
    noLibuv();
}

pub export fn lean_uv_tcp_shutdown(socket: *anyopaque) callconv(.c) *anyopaque {
    _ = socket;
    noLibuv();
}

pub export fn lean_uv_tcp_getpeername(socket: *anyopaque) callconv(.c) *anyopaque {
    _ = socket;
    noLibuv();
}

pub export fn lean_uv_tcp_getsockname(socket: *anyopaque) callconv(.c) *anyopaque {
    _ = socket;
    noLibuv();
}

pub export fn lean_uv_tcp_nodelay(socket: *anyopaque) callconv(.c) *anyopaque {
    _ = socket;
    noLibuv();
}

pub export fn lean_uv_tcp_keepalive(socket: *anyopaque, enable: u8, delay: u32) callconv(.c) *anyopaque {
    _ = socket;
    _ = enable;
    _ = delay;
    noLibuv();
