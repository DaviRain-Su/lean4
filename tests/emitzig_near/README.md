...
- The Layer 3 SDK surface covered here includes typed storage, Rust-SDK-shaped store collections, environment context, promise creation/callbacks, and U128-backed `NearToken` transfers.
